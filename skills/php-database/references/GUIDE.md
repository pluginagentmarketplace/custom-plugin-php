...
This guide provides comprehensive documentation for the **php-database** skill in the custom-plugin-php plugin.
...
```bash
# Invoke the skill
claude "php-database - [your task description]"

# Example
claude "php-database - analyze the current implementation"
```
...
def implement_php_database(input_data):
    """
    Implement php-database functionality.
