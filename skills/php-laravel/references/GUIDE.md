...
This guide provides comprehensive documentation for the **php-laravel** skill in the custom-plugin-php plugin.
...
```bash
# Invoke the skill
claude "php-laravel - [your task description]"

# Example
claude "php-laravel - analyze the current implementation"
```
...
def implement_php_laravel(input_data):
    """
    Implement php-laravel functionality.
