...
This guide provides comprehensive documentation for the **php-wordpress** skill in the custom-plugin-php plugin.
...
```bash
# Invoke the skill
claude "php-wordpress - [your task description]"

# Example
claude "php-wordpress - analyze the current implementation"
```
...
def implement_php_wordpress(input_data):
    """
    Implement php-wordpress functionality.
