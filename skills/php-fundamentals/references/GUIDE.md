...
This guide provides comprehensive documentation for the **php-fundamentals** skill in the custom-plugin-php plugin.
...
```bash
# Invoke the skill
claude "php-fundamentals - [your task description]"

# Example
claude "php-fundamentals - analyze the current implementation"
```
...
def implement_php_fundamentals(input_data):
    """
    Implement php-fundamentals functionality.
