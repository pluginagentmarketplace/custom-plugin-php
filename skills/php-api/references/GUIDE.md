...
This guide provides comprehensive documentation for the **php-api** skill in the custom-plugin-php plugin.
...
```bash
# Invoke the skill
claude "php-api - [your task description]"

# Example
claude "php-api - analyze the current implementation"
```
...
def implement_php_api(input_data):
    """
    Implement php-api functionality.
